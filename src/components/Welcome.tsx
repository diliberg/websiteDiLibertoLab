...
const slides = [
  ...
  {
    url: "https://diliberg.github.io/websiteDiLibertoLabImages/2025-2labphoto_1.jpg",
    alt: "Di Liberto Lab team"
  },
    {
    url: "https://diliberg.github.io/websiteDiLibertoLabImages/2025-2labphoto_3.jpg",
    alt: "Di Liberto Lab team"
  },
  {
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {onViewAllNews && (
            <button
              ...
              className="text-blue-600 hover:text-blue-800 text-2xl font-semibold hover:underline inline-flex items-center"
            >
              See all news →
            </button>
          )}
